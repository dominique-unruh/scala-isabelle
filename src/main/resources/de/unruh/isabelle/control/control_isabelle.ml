(* TODO port changes to control_isabelle_logged *)
...
structure Control_Isabelle : sig
  ...
  (* Do not use (accessible only for use in autogenerated code) *)
...
(* Takes mutex *)
val addToObjects = withMutex addToObjects'

...
class VersionTest extends org.scalatest.funsuite.AnyFunSuite {
  test("parse version") {
    ...
    string match {
      ...
      case "Isabelle2022" =>
        assert(triple == (2022, 0, NOT_RC))
      case "Isabelle2023-RC0" =>
      ...
      case "Isabelle2023" =>
        assert(triple == (2023, 0, NOT_RC))
      case "Isabelle2024" =>
        assert(triple == (2024, 0, NOT_RC))
      case "Isabelle2025" =>
        assert(triple == (2025, 0, NOT_RC))
      case "Isabelle2025-1" =>
        assert(triple == (2025, 1, NOT_RC))
      case "Isabelle2025-2" =>
        assert(triple == (2025, 2, NOT_RC))
      case _ =>
